			...
			<div class="fullwidthbanner1">
				...
				<!-- SLIDE  -->
					<li data-transition="parallaxtoright,parallaxtoleft" data-slotamount="7" data-masterspeed="600"  data-saveperformance="off" >
						<!-- MAIN IMAGE -->
						<img src="img/slider/slider-1/slider1.jpg"  alt="slider1"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
						<!-- LAYERS -->
						...
						<div class="tp-caption sfl" 
							...
							style="z-index: 5;"><img src="img/slider/slider-1/img-slider1.png" alt=""> 
						</div>
						...
						<div class="tp-caption customin" 
							...
							style="z-index: 9;"><a href="#" target="_blank"><img src="img/slider/slider-1/shopping.jpg" alt=""></a> 
						</div>
					</li>
				<!-- SLIDE  -->
					<li data-transition="parallaxtoright,parallaxtoleft" data-slotamount="7" data-masterspeed="600"  data-saveperformance="off" >
						<!-- MAIN IMAGE -->
						<img src="img/slider/slider-1/slider2.jpg"  alt="slider2"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
						<!-- LAYERS -->
						...
						<div class="tp-caption tp-fade" 
							...
							style="z-index: 8;"><a href="#" target="_blank"><img src="img/slider/slider-1/shopping.jpg" alt=""></a> 
						</div>
					</li>	
				</ul>
			</div>
	...
	<div class="promotion-area">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-4">
					<div class="single-promo">
						<a href="#"><img src="img/promotion/3.jpg" alt="" /></a>
					</div>
				</div>
				<!-- single-promo end -->
			</div>
										...
										<div class="col-md-6">
											...
											<div class="single-category-tab">
												<div class="single-features">
													<div class="product-img">
														<a href="#">
															<img class="first-img" src="img/product/8.jpg" alt="" />
															<img class="second-img" src="img/product/13.jpg" alt="" />
														</a>
													</div>
													<div class="product-content">
														<div class="pro-rating">
											...
											<div class="single-category-tab">
												<div class="single-features">
													<div class="product-img">
														<a href="#">
															<img class="first-img" src="img/product/14.jpg" alt="" />
										...
										<div class="col-md-6">
											...
											<div class="single-category-tab">
												<div class="single-features">
													<div class="product-img">
														<a href="#">
															<img class="first-img" src="img/product/12.jpg" alt="" />
														</a>
													</div>
													<div class="product-content">
														<div class="pro-rating">
												...
												<div class="single-features">
													<div class="product-img">
														<a href="#">
															...
															<img class="second-img" src="img/product/17.jpg" alt="" />
														</a>
													</div>
													<div class="product-content">
														<div class="pro-rating">
										...
										<div class="col-md-6">
											...
											<div class="single-category-tab">
												<div class="single-features">
													<div class="product-img">
														<a href="#">
															<img class="first-img" src="img/product/18.jpg" alt="" />
														</a>
													</div>
													<div class="product-content">
														<div class="pro-rating">
												...
												<div class="single-features">
													<div class="product-img">
														<a href="#">
															...
															<img class="second-img" src="img/product/22.jpg" alt="" />
														</a>
													</div>
													<div class="product-content">
														<div class="pro-rating">
