    ...
    <div class="row">
      <div class="col-main col-sm-9 col-sm-push-3">
        <article class="col-main">
          ...
          <li class="item first">
            <div class="product-image"> <a href="product_detail.html" title="Sample Product"> <img class="small-image" src="products-images/product1.jpg" alt="Sample Product"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product_detail.html" title="Sample Product">Sample Product</a></h2>
              <div class="ratings">
          ...
          <li class="item even">
            <div class="product-image"> <a href="product_detail.html" title="Sample Product"> <img class="small-image" src="products-images/product2.jpg" alt="Sample Product"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product_detail.html" title="Sample Product">Sample Product</a></h2>
              <div class="desc std">
                <p>Sed volutpat ac massa eget 
          ...
          <li class="item odd">
            <div class="product-image"> <a href="product_detail.html" title="Sample Product"> <img class="small-image" src="products-images/product3.jpg" alt="Sample Product"> </a> </div>
            <div class="product-shop">
          ...
          <li class="item even">
            <div class="product-image"> <a href="product_detail.html" title="Sample Product"> <img class="small-image" src="products-images/product4.jpg" alt="Sample Product"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product_detail.html" title="Sample Product">Sample Product</a></h2>
          ...
          <li class="item odd">
            <div class="product-image"> <a href="product_detail.html" title="Sample Product"> <img class="small-image" src="products-images/product5.jpg" alt="Sample Product"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product_detail.html" title="Sample Product">Sample Product</a></h2>
          ...
          <li class="item even">
            <div class="product-image"> <a href="product_detail.html" title="Sample Product"> <img class="small-image" src="products-images/product6.jpg" alt="Sample Product"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product_detail.html" title="Sample Product">Sample Product</a></h2>
              <div class="desc std">1 TB - 7200RPM, SATA 3.0Gb/s, 32MB Cache
          ...
          <li class="item odd">
            <div class="product-image"> <a href="product_detail.html" title="Sample Product"> <img class="small-image" src="products-images/product7.jpg" alt="Sample Product"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product_detail.html" title="Sample Product">Sample Product</a></h2>
          ...
          <li class="item even">
            <div class="product-image"> <a href="product_detail.html" title="Sample Product"> <img class="small-image" src="products-images/product8.jpg" alt="Sample Product"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product_detail.html" title="Sample Product">Sample Product</a></h2>
          ...
          <li class="item odd">
            <div class="product-image"> <a href="product_detail.html" title="Sample Product"> <img class="small-image" src="products-images/product9.jpg" alt="Sample Product"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product_detail.html" title="Sample Product">Sample Product</a></h2>
          ...
          <li class="item last even">
            <div class="product-image"> <a href="product_detail.html" title="Sample Product"> <img class="small-image" src="products-images/product10.jpg" alt="Sample Product"> </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product_detail.html" title="Sample Product">Sample Product</a></h2>
              <div class="ratings">
                <div class="rating-box">
