        ...
        <div class="multiple_addresses">
          <form method="post" action="#" id="checkout_multishipping_form">
            ...
            <div class="title-buttons pull-right">
              <button class="button new-address" title="Enter a New Address" ><span>Enter a New Address</span></button>
            </div>
            <!--title-buttons-->
            <div class="addresses">
                  ...
                  <table id="multiship-addresses-table" class="data-table">
                    ...
                    <tbody>
                      ...
                      <tr class="odd">
                        ...
                        <td class="a-center last"><a href="#" title="&lt;span&gt;Remove item&lt;/span&gt;" class="btn-remove btn-remove2"><span>Remove item</span></a></td>
                      </tr>
                      <tr class="even">
